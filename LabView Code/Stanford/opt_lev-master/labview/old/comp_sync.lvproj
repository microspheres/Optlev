...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="filenames.lvlib" Type="Library" URL="../filenames.lvlib"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="flash_cycle(SubVI).vi" Type="VI" URL="../flash_cycle(SubVI).vi"/>
			<Item Name="flasher(SubVI).vi" Type="VI" URL="../flasher(SubVI).vi"/>
			<Item Name="Get Full Terminal Name.vi" Type="VI" URL="/C/Program Files/National Instruments/LabVIEW 2012/examples/DAQmx/Synchronization/SubVIs/Get Full Terminal Name.vi"/>
			<Item Name="hdf5(SubVI).vi" Type="VI" URL="../hdf5(SubVI).vi"/>
			<Item Name="HP 3325A Function Gen.vi" Type="VI" URL="../HP 3325A Function Gen.vi"/>
			<Item Name="MultiChannelFeed_FPGATarget2_feedbackcooling(_T5hmXv3JUos.lvbitx" Type="Document" URL="../fpga/MultiChannelFeed_FPGATarget2_feedbackcooling(_T5hmXv3JUos.lvbitx"/>
			...
			<Item Name="read_pressure(SubVI).vi" Type="VI" URL="../read_pressure(SubVI).vi"/>
			<Item Name="read_temps(SubVI).vi" Type="VI" URL="../read_temps(SubVI).vi"/>
