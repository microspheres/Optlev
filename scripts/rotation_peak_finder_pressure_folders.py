...
file_list1 = file_list1[::20]

path2 = r"C:\data\20180129\bead1_um_POL_NS_SiO2_10um\pressures4"


file_list2 = glob.glob(path2+"\*.h5")
file_list2 = list_file_time_order(file_list2)
file_list2 = file_list2[::20]

path3 = r"C:\data\20180129\bead1_um_POL_NS_SiO2_10um\pressures5_changePol"


file_list3 = glob.glob(path3+"\*.h5")
file_list3 = list_file_time_order(file_list3)
file_list3 = file_list3[::20]



path4 = r"C:\data\20180129\bead1_um_POL_NS_SiO2_10um\pressures6_changePol-1"


file_list4 = glob.glob(path4+"\*.h5")
file_list4 = list_file_time_order(file_list4)
file_list4 = file_list4[::20]

path5 = r"C:\data\20180129\bead1_um_POL_NS_SiO2_10um\pressures7_changePol-1"


file_list5 = glob.glob(path5+"\*.h5")
file_list5 = list_file_time_order(file_list5)
file_list5 = file_list5[::10]

file_list1 = file_list1 + file_list2 + file_list3 + file_list4 + file_list5
...
c1 = finder(file_list1, 23400., 0.8, 20000./4)
...
# p02 = [-510.0 , (6.27E6)/6.E-7, (1/11000)*(6.E-7)]
# popt2, pcov2 = curve_fit(func2, (c1[2][150:200], c1[1][150:200]), c1[0][150:200], p0 = np.array(p02))

p03 = [-2.E4 ,0.8E6, 1E4, 2.E5]
popt3, pcov3 = curve_fit(funcdecay, c1[2][240:277], c1[0][240:277], p0 = np.array(p03))

# p04 = [-2.85E4 ,0.1E6, 0.78E4, 2.E5]
# popt4, pcov4 = curve_fit(funcdecay, c1[2][-30:], c1[0][-30:], p0 = np.array(p04))
